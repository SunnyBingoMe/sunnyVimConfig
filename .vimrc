...
set noexpandtab tabstop=4 autoindent "do not expand tab as spaces.	the real tab; and the default value for other
"set expandtab tabstop=4 shiftwidth=4 softtabstop=4 autoindent "expand tab as spaces."should be used if 'set expandtab'
"set textwidth=80
...
nnoremap C "_C
vnoremap C "_C
set clipboard=unnamed "http://goo.gl/rafSW
imap <C-BS> <C-w>
imap <M-S-h> <C-Left>
imap <M-S-l> <C-Right>
nmap <M-f> <C-f>
...
nmap <CR> <Leader>ci
vmap <CR> <Leader>ci
nmap <S-CR> <Leader>c<Space>
vmap <S-CR> <Leader>c<Space>
