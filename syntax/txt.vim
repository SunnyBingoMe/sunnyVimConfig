...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"Keywords
syn keyword txtTodo todo fixme note debug comment OBS notice
syn keyword txtError ERR WARNING EE WW II error bug caution dropped
...
"
syn match txtTitle "^\s*\(\d\+ \)\+\s*"
syn match txtTitle "^\s*\(\d\+\.\)\+\d*\s*"
